...
Instructions are split into the same three sections used throughout `description/`:
...
Each section must also list which `description/` spec files need updating as a result of the change (e.g. "Update `description/functional/navigation.md` to…").
