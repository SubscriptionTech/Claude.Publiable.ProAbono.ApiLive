...
A full-width SVG diagram illustrating the entity relationships. Update this diagram when the entity model changes.
...
Add a `tip` admonition: once set, a shared reference can be used in place of the internal `Id` in any API Live call targeting that resource.
...
Reference page for cross-cutting technical conventions: field naming, special field types, pagination, localization, HTTP status codes, and error response shapes.
