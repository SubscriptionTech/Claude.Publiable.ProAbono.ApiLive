...
The ProAbono API Live lets you manage subscriptions programmatically — create customers, start or update subscriptions, check feature access, and simulate billing costs before committing to a change.
...
For testing, use the pre-production variant:

```
https://pp-api-<IdBusiness>.proabono.com/
```

See [Authentication](../authentication/) for the full environment table.
