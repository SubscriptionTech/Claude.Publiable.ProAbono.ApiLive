...
Reference for cross-cutting technical conventions: field naming, special field types, pagination, localization, HTTP status codes, and error response shapes.
